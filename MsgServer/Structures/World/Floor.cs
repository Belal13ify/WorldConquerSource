    ...
    public class Floor
    {
        ...
        /* public virtual Tile this[int x, int y]
        {
            get
            {
                try
                {
                    // Adjusting the index calculation for a 2D array
                    return Coordinates[(y * Boundaries.Width) + x];
                }
                catch
                {
                    return new Tile(TileType.TERRAIN, 999, -1);
                }
            }
            set
            {
                // Adjusting the index calculation for a 2D array
                Coordinates[(y * Boundaries.Width) + x] = value;
            }
        } */
